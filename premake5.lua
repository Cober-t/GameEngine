...
IncludeDir["SDL3"]          = "%{wks.location}/libraries/SDL/include"
...
IncludeDir["msdf"]          = "%{wks.location}/libraries/msdf/msdf-atlas-gen"
IncludeDir["msdfgen"]       = "%{wks.location}/libraries/msdf/msdfgen"
