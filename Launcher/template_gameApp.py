...
public:
	...
	{{
		...
		EngineApp::SetSceneMode(EngineApp::SceneMode::PLAY);
	}}
...
{{
	m_Camera = CreateRef<GameCamera>(45.0f, EngineApp::GetWindow().GetWidth(), EngineApp::GetWindow().GetHeight(), 0.01f, 1000.0f, GlobalCamera::perspective);
}}
