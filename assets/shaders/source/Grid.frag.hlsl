...
float4 grid(float3 fragPos3D, float scale, bool drawAxis, int game2D)
{
    ...
    float2 gridVal = abs(frac(coord - 0.5) - 0.5) / derivative;
...
float calculateAttenuation(float range, float3 cameraPosition, float3 worldPoint)
{
    ...
    if (rangeInt == 7)      { constant = 1.0; linearTerm = 0.7;    quadratic = 1.8;   }
    else if (rangeInt == 13) { constant = 1.0; linearTerm = 0.35;   quadratic = 0.44;  }
    else if (rangeInt == 20) { constant = 1.0; linearTerm = 0.22;   quadratic = 0.20;  }
    else if (rangeInt == 50) { constant = 1.0; linearTerm = 0.14;   quadratic = 0.07;  }
    else if (rangeInt == 65) { constant = 1.0; linearTerm = 0.09;   quadratic = 0.032; }
    else if (rangeInt == 100){ constant = 1.0; linearTerm = 0.07;   quadratic = 0.017; }
    else if (rangeInt == 160){ constant = 1.0; linearTerm = 0.045;  quadratic = 0.0075;}
    else if (rangeInt == 200){ constant = 1.0; linearTerm = 0.027;  quadratic = 0.0028;}
    else if (rangeInt == 325){ constant = 1.0; linearTerm = 0.022;  quadratic = 0.0019;}
    else if (rangeInt == 600){ constant = 1.0; linearTerm = 0.014;  quadratic = 0.0007;}
    else if (rangeInt == 3250){constant = 1.0; linearTerm = 0.007;  quadratic = 0.0002;}
    else                     { constant = 1.0; linearTerm = 1.0;    quadratic = 1.0;   }

    float dist = length(cameraPosition.xz - worldPoint.xz);
    float att = 1.0 / (constant + linearTerm * dist + quadratic * (dist * dist));
